                ...
                <div className="row">
                    <div className="col col-lg-6 col-12">
                        ...
                        <div className="cta-text">
                            <p>Partner with Digiroc Technologies for comprehensive market research, data analytics, and IT distribution services. Our team of experts is ready to help you achieve your strategic objectives and drive sustainable growth.</p>
